...
(function () {
  ...
  const NAV_HELP = {
    root: [
      ...
      { q: "Where can I read about what a trip includes?", kw: "experience included what happens itinerary details activities", a: "That's the <b>The Experience</b> section on this page — it walks through what a trip with us actually looks like, start to finish.", href: "#experiences" },
      { q: "Why should I book with you?", kw: "why book us trust safe safety reasons choose", a: "See the <b>Why Book Us</b> section on this page — it covers safety, local guides, and what makes us different from a random tour operator.", href: "#booking" },
      { q: "Where can I learn about your company?", kw: "about us who are you company team story", a: "That's the <b>About Us</b> section further down this page — our story and how we got started.", href: "#about" },
      { q: "How do I contact you?", kw: "contact phone number email whatsapp reach call", a: "Scroll to the very bottom of this page — the footer has our phone number, email and social links. Tap the phone number to call directly, or the WhatsApp/Instagram icons to message us there.", href: "#footer" },
      ...
      { q: "Is there a discount or sale running right now?", kw: "discount sale offer promo coupon deal", a: "Active sales are shown right on the package cards themselves. Open a destination's <b>Packages</b> page (via Explore Destination above) and look for a struck-through price with a \u201cX% OFF\u201d badge.", href: "#destinations" }
    ],
    "krem-chympe": [
      { q: "Where do I see packages and prices?", kw: "package packages price prices pricing cost how much", a: "That's the <b>Packages</b> page. Once you're there, compare the Shared Package (fixed per-person rate) and Private Package (fully custom), then tap \u201cBook Now\u201d on whichever fits your group.", href: "index.html?page=2#kc-packages" },
      ...
      { q: "Where can I read the full story about Krem Chympe?", kw: "story about explore what is krem chympe waterfall cave", a: "That's the <b>Explore</b> section on the Home page — the waterfall and cave stories, and what to expect on the trek.", href: "index.html?page=1#kc-explore" },
      { q: "How do I contact you / get your phone number?", kw: "contact phone number whatsapp email reach call", a: "That's the <b>Contact</b> section at the bottom of the Home page — tap the phone number to call, or the WhatsApp icon to message us directly.", href: "index.html?page=1#kc-contact" },
      ...
      { q: "How do I pay for my booking?", kw: "pay payment upi qr bank transfer how to pay", a: "After filling in your group details on the <b>Packages</b> page, you'll see a QR code / UPI ID / bank details on screen. Pay using any of those, then upload a screenshot of the payment as your receipt — that's the last step before submitting.", href: "index.html?page=2#kc-packages" },
    ...
    "wilderness-expedition": [
      { q: "Where do I see packages and prices?", kw: "package packages price prices pricing cost how much expedition", a: "That's the <b>Packages</b> page. Open it, review the Expedition Package details, then tap \u201cBook Now\u201d to start.", href: "index.html?page=2#kc-packages" },
      { q: "Where's the photo gallery?", kw: "photo photos gallery pictures images", a: "That's the <b>Gallery</b> section on the Home page — scroll or swipe through it, and tap any photo to view it full-size.", href: "index.html?page=1#kc-gallery" },
      { q: "Where can I read the full story about the expedition?", kw: "story about explore what is wilderness expedition trek route", a: "That's the <b>Explore</b> section on the Home page — the route, terrain and what to expect day by day.", href: "index.html?page=1#kc-explore" },
      { q: "How do I contact you / get your phone number?", kw: "contact phone number whatsapp email reach call", a: "That's the <b>Contact</b> section at the bottom of the Home page — tap the phone number to call, or the WhatsApp icon to message us directly.", href: "index.html?page=1#kc-contact" },
  ...
  style.textContent = `
    ...
    #era-ai-panel{position:fixed;right:16px;bottom:154px;z-index:45;width:min(340px,calc(100vw - 32px));
      ...
      opacity:0;transform-origin:bottom right;transform:translateY(16px) scale(.82);pointer-events:none;
      transition:opacity .32s cubic-bezier(.2,.8,.2,1), transform .32s cubic-bezier(.2,.8,.2,1);font:400 13px/1.5 "Inter",sans-serif;color:#fff;}
