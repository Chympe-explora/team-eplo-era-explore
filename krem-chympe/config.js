...
(function () {
  ...
  // ============================================================
    window.KC_IMAGES = {
      ...
      // Extra real trip photos — added to the gallery grid
      gallery10: "Suspension Bridge Crossing.jpg",
      gallery11: "Cave Pool Celebration.jpg",
      gallery12: "Solo Waterfall View.jpg",
      gallery13: "Group Waterfall Cheer.jpg",
      ...
      // "Why Visit Krem Chympe?" — one image slot per journey card
      // (The Journey / The Trek / The Cave / The Thrill). Leave blank
      // ("") until you upload a photo — an empty/disabled slot never
      // shows a broken image, the card just looks normal without one.
      ...
      whyVisit: {
        ...
        journeys: [
          ...
          },
          {
            ...
            imageSlot: { enabled: true, image: window.KC_IMAGES.whyThrill, alt: "The Thrill — cliff jumping" }
          }
        ]
      },
...
"Waterfall Swimming"
    ...
    "Waterfall Swimming"
      ...
      galleryImages: [
        ...
        { id: 10, cat: "Trek",      src: window.KC_IMAGES.gallery10, span: "col-span-4" },
        { id: 11, cat: "Cave",      src: window.KC_IMAGES.gallery11, span: "col-span-4" },
        { id: 12, cat: "Waterfall", src: window.KC_IMAGES.gallery12, span: "col-span-4" },
        { id: 13, cat: "Waterfall", src: window.KC_IMAGES.gallery13, span: "col-span-8" }
      ],
      ...
      ui: {
        ...
        // ---- Added: previously hard-coded text now editable here too ----
