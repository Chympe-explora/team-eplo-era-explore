...
(function () {
  ...
  // ==========================================================
  // 🖼️ IMAGE SLOTS — extra photo spots added throughout the site
  // (Experiences section + About Us section). Each slot has:
  //   "enabled": true/false  → turn this photo on or off anywhere,
  //                            the page always looks normal either way
  //   "image":   filename     → which photo shows (also editable from
  //                            Telegram Admin → 🖼️ Change Photos)
  //   "alt":     description  → for accessibility / SEO, optional
  // Turning "enabled" to false hides the photo completely and closes
  // the gap — nothing looks broken or empty.
  // ==========================================================
  "imageSlots": {
    "exp_cave": { "enabled": true, "image": "Cave Mouth Waterfall View.jpg", "alt": "Inside the Krem Chympe cave" },
    "exp_waterfall": { "enabled": true, "image": "Group Waterfall Photo.jpg", "alt": "Chympe waterfall" },
    ...
    "about_offer_1": { "enabled": true, "image": "Happy waterfall.jpg", "alt": "Krem Chympe Falls & Caves" },
